...
\begin{itemize}
    ...
    \item \textbf{Unpure questions}: The question contains both visual representations and text needed in order to solve the question.
\end{itemize}
...
\begin{tabular}{lcccc}
\toprule
\textbf{Input format} & \textbf{Accuracy} & \textbf{$p$ (vs.\ 25\%)} & \textbf{$p$ (vs.\ 50\%)} & \textbf{Consistently pass} \\
\midrule
Pure text + Pure image + Paired image  & 50.4\% & $5.6 \times 10^{-28}$ & $0.44$               & No  \\
Pure text + Pure image + Paired text   & 56.8\% & $4.8 \times 10^{-42}$ & $3.0 \times 10^{-3}$ & Yes \\
\bottomrule
\end{tabular}
\end{center}
