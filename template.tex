...
Pure image, screenshot only  & 52  & 144 & 36.1\% \\
\midrule
...
Paired question, text description &  80 & 127 & 63.0\% & [54.3,\,70.9] \\
Paired question, screenshot       &  54 & 127 & 42.5\% & [34.3,\,51.2] \\
Pure image, screenshot only       &  52 & 144 & 36.1\% & [28.7,\,44.2] \\
\midrule
...
Screenshot only & 36.1\% & $2.0 \times 10^{-3}$  \\
\bottomrule
\end{tabular}
\end{center}
...
To simulate a realistic full exam, one modality was assigned per question as it would be in practice: pure text questions as text, pure image and paired questions as screenshots. The results are shown below alongside the best-case scenario where text descriptions are provided for paired questions instead of screenshots.
