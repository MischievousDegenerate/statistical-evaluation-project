...
where $\hat{p}$ is the observed accuracy and $n$ is the number of questions. The value $1.96$ is the $97.5\%$ quantile of the standard normal distribution and the samples are large enough for the normal approximation to be reasonable.
