...
We ran one-sided binomial tests on each input format against two baselines: the 25\% accuracy expected from guessing among the four options A--D ($H_0: p = 0.25$), and the 50\% DTU passing threshold ($H_0: p = 0.50$). Both families of four tests are Bonferroni-corrected.
