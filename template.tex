...
The dataset employed in this study consists of publicly available examination sets from the DTU course \textit{Introduction to Machine Learning and Data Mining} (course number 02450, renumbered 02452 as \textit{Machine Learning} for the December 2025 exam) spanning the years 2017--2025. Both the spring and fall examinations were included, resulting in a total of 16 exam sets. Each examination contains 27 multiple-choice questions, yielding a total sample size of 432 questions.
