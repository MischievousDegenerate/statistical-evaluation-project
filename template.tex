...
For the contamination check, a one-sided test compared pre-cutoff (2017--2024) accuracy against post-2025 accuracy, with each question counted once. The results run counter to what would be expected under data contamination, regardless of how the paired questions are prompted. Since performance is consistently higher on the 2025 exams in both conditions, there is no evidence that suggests that Gemma has been trained on the pre-2025 exams.training-data memorization is inflating the results.
